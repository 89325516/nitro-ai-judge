...
import numpy as np
PINNED_COMMIT='6c724e8877c52ea021f295216949860f87d1c8b2'; RAW_BASE='https://raw.githubusercontent.com/ana0101/eye-tracking/6c724e8877c52ea021f295216949860f87d1c8b2/trt_model/word_sentence_fixations'; SUBJECTS=['008', '009', '010', '011', '023']; CONFIG={'mode': 'blend', 'high_variant': 'cal_direct', 'gamma': 4.0, 'direction_weight': 0.3, 'weights': {'safe': 0.04, 'medium': 0.18, 'high': 0.78}, 'scale': 1.0, 'mapping': {'040': '010', '036': '011', '016': '008', '024': '023', '019': '009'}}
