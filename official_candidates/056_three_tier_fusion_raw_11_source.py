...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.4, 'medium': 0.3, 'high': 0.3}, 'scale': 1.08, 'mapping': {'040': '008', '036': '010', '016': '023', '024': '009', '019': '011'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
