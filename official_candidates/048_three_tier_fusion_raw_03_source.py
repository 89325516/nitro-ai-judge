...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.2, 'medium': 0.15, 'high': 0.65}, 'scale': 0.92, 'mapping': {'040': '008', '036': '009', '016': '011', '024': '010', '019': '023'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
