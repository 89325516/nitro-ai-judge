...
import numpy as np
CONFIG={'mode': 'hurdle', 'positive': 'hybrid', 'zero_weight': 0.7, 'weight': 0.16, 'model': 'hgb', 'trees': 128}; RAW_BASE='https://raw.githubusercontent.com/ana0101/eye-tracking/6c724e8877c52ea021f295216949860f87d1c8b2/trt_model/word_sentence_fixations'; WORD_RE=re.compile(r"^(.*)_([0-9]+)_page_([0-9]+)_([0-9]+)$"); FAMS=("arg","enc","ins","lit","popsci")
def rc(p):
