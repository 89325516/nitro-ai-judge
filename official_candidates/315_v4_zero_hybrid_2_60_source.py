...
CONFIG={'mode': 'single', 'source': 'hard', 'zero_strategy': 'hybrid', 'movement_weight': 1.0, 'mapping': {'040': '009', '036': '008', '016': '011', '024': '023', '019': '010'}, 'target_std': 180, 'zero_threshold': 0.6}
def main():
