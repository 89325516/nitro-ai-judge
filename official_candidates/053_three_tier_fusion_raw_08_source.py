...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.2, 'medium': 0.3, 'high': 0.5}, 'scale': 0.96, 'mapping': {'040': '008', '036': '010', '016': '009', '024': '023', '019': '011'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
