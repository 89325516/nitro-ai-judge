...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.35, 'medium': 0.25, 'high': 0.4}, 'scale': 1.04, 'mapping': {'040': '008', '036': '010', '016': '011', '024': '009', '019': '023'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
