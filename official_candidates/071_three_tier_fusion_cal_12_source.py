...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.3, 'medium': 0.4, 'high': 0.3}, 'scale': 1.02, 'mapping': {'040': '010', '036': '008', '016': '011', '024': '023', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
