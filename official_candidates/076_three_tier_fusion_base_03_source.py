...
CONFIG={'mode': 'base', 'weights': {'safe': 0.2, 'medium': 0.15, 'high': 0.65}, 'scale': 0.98, 'mapping': {'040': '008', '036': '010', '016': '011', '024': '023', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
