...
CONFIG={'mode': 'base', 'weights': {'safe': 0.35, 'medium': 0.25, 'high': 0.4}, 'scale': 1.08, 'mapping': {'040': '009', '036': '008', '016': '023', '024': '011', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
