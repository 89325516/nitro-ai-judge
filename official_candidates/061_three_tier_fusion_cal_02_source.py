...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.15, 'medium': 0.15, 'high': 0.7}, 'scale': 0.92, 'mapping': {'040': '008', '036': '009', '016': '023', '024': '011', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
