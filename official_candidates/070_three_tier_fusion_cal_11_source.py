...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.4, 'medium': 0.3, 'high': 0.3}, 'scale': 0.98, 'mapping': {'040': '009', '036': '023', '016': '008', '024': '011', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
