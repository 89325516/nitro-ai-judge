...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.25, 'medium': 0.2, 'high': 0.55}, 'scale': 1.0, 'mapping': {'040': '008', '036': '011', '016': '023', '024': '009', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
