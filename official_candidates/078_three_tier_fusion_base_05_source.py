...
CONFIG={'mode': 'base', 'weights': {'safe': 0.15, 'medium': 0.25, 'high': 0.6}, 'scale': 1.0, 'mapping': {'040': '008', '036': '011', '016': '009', '024': '023', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
