...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.25, 'medium': 0.35, 'high': 0.4}, 'scale': 1.08, 'mapping': {'040': '009', '036': '011', '016': '008', '024': '023', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
