...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.1, 'medium': 0.25, 'high': 0.65}, 'scale': 0.98, 'mapping': {'040': '008', '036': '010', '016': '023', '024': '011', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
