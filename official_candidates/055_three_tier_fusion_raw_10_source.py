...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.25, 'medium': 0.35, 'high': 0.4}, 'scale': 0.92, 'mapping': {'040': '008', '036': '010', '016': '011', '024': '023', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
