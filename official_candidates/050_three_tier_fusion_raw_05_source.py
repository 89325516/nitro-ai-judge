...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.15, 'medium': 0.25, 'high': 0.6}, 'scale': 0.98, 'mapping': {'040': '008', '036': '009', '016': '023', '024': '010', '019': '011'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
