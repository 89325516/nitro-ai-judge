...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.2, 'medium': 0.45, 'high': 0.35}, 'scale': 0.96, 'mapping': {'040': '010', '036': '011', '016': '008', '024': '023', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
