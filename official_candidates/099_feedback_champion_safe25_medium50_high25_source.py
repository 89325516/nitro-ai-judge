...
CONFIG={'mode': 'base', 'weights': {'safe': 0.25, 'medium': 0.5, 'high': 0.25}, 'scale': 1.02, 'mapping': {'040': '010', '036': '011', '016': '008', '024': '023', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
