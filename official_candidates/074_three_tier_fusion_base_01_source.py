...
CONFIG={'mode': 'base', 'weights': {'safe': 0.1, 'medium': 0.15, 'high': 0.75}, 'scale': 0.92, 'mapping': {'040': '008', '036': '009', '016': '010', '024': '011', '019': '023'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
