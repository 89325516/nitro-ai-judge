...
CONFIG={'mode': 'base', 'weights': {'safe': 0.3, 'medium': 0.2, 'high': 0.5}, 'scale': 1.04, 'mapping': {'040': '008', '036': '023', '016': '009', '024': '011', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
