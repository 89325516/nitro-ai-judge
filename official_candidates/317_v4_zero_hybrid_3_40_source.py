...
CONFIG={'mode': 'single', 'source': 'hard', 'zero_strategy': 'hybrid', 'movement_weight': 1.0, 'mapping': {'040': '023', '036': '008', '016': '009', '024': '010', '019': '011'}, 'target_std': 180, 'zero_threshold': 0.4}
def main():
