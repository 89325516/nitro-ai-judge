...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.3, 'medium': 0.4, 'high': 0.3}, 'scale': 0.98, 'mapping': {'040': '008', '036': '010', '016': '023', '024': '011', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
