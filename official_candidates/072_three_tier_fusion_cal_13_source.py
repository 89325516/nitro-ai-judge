...
CONFIG={'mode': 'cal', 'weights': {'safe': 0.45, 'medium': 0.25, 'high': 0.3}, 'scale': 1.0, 'mapping': {'040': '010', '036': '008', '016': '023', '024': '011', '019': '009'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
