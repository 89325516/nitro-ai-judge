...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.45, 'medium': 0.25, 'high': 0.3}, 'scale': 1.02, 'mapping': {'040': '008', '036': '011', '016': '009', '024': '010', '019': '023'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
