...
CONFIG={'mode': 'raw', 'weights': {'safe': 0.1, 'medium': 0.25, 'high': 0.65}, 'scale': 1.08, 'mapping': {'040': '008', '036': '009', '016': '011', '024': '023', '019': '010'}, 'risk_labels': ['safe_external_generalization', 'medium_public_behavior_mapping', 'high_risk_public_reconstruction']}
