...
import numpy as np
PINNED_COMMIT='6c724e8877c52ea021f295216949860f87d1c8b2'; RAW_BASE='https://raw.githubusercontent.com/ana0101/eye-tracking/6c724e8877c52ea021f295216949860f87d1c8b2/trt_model/word_sentence_fixations'; SUBJECTS=['008', '009', '010', '011', '023']; CONFIG={'mode': 'component', 'component': 'stack', 'model': 'ridge_log', 'weight': 0.12, 'mapping': {'040': '010', '036': '011', '016': '008', '024': '023', '019': '009'}, 'counter': 0.08}
