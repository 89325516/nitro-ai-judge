...
try:
    from experiments.noise_aware_v3_process import generate
except ModuleNotFoundError:
    from noise_aware_v3_process import generate


def main() -> None:
    parser = argparse.ArgumentParser(description="Generate noise-aware V3 low-noise candidates.")
    ...
    gen.add_argument("--neutral-output", type=Path, required=True)
